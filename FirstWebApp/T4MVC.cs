...
{
    public static FirstWebApp.Controllers.AccountController Account = new FirstWebApp.Controllers.T4MVC_AccountController();
    public static FirstWebApp.Controllers.HomeController Home = new FirstWebApp.Controllers.T4MVC_HomeController();
